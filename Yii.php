...
$yii2path =__DIR__.'/../../yiisoft/yii2';
require($yii2path . '/BaseYii.php'); // Yii 2.x

$yii1path = __DIR__.'/../../yiisoft/yii/framework';
 ...
 */
defined('YII_PATH') or define('YII_PATH',$yii1path);
/**
...
//			elseif(isset(self::$aliases['@'.$rootAlias]) ){echo '---';
//				return self::$_aliases[$alias]=rtrim(self::$aliases['@'.$rootAlias].DIRECTORY_SEPARATOR.str_replace('.',DIRECTORY_SEPARATOR,substr($alias,$pos+1)),'*'.DIRECTORY_SEPARATOR);
//			}
...
//           throw new UnknownClassException("Unable to find '$className' in file: $classFile. Namespace missing?");
			self::warning("Unable to find '$className' in file: $classFile.");
        }
    }
	 ...
	 */
	public static function autoload_1($className,$classMapOnly=false)
	{
...
//	}
	...
	{
		return Yii::t('yii','Powered by {yii} & {fufudao}.', ['{yii}'=>'<a href="http://www.yiiframework.com/" rel="external">Yii Framework</a>','{fufudao}'=>'<a href="http://www.fufudao.com/" rel="external">fufudao</a>']);
	}
